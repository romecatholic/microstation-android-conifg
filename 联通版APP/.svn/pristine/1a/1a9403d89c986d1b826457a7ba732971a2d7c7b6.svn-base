...
public class AlarmNoConfirmSearchFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mBaseView = inflater.inflate(R.layout.frag_alarm_no_search_page, null);
		...
		stationName=(EditText) mBaseView.findViewById(R.id.alarm_search_staiton_name);
		...
		searchButton = (Button) mBaseView.findViewById(R.id.search_no);
		...
		et_alarm_type.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				new AlertDialog.Builder(getActivity()).setTitle(getResources().getString(R.string.seleReg)).setItems(alarm_items,new DialogInterface.OnClickListener(){//选择区域  
		...
		area.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new AlertDialog.Builder(getActivity()).setTitle(getResources().getString(R.string.seleReg)).setItems(items,new DialogInterface.OnClickListener(){//选择区域  
				      public void onClick(DialogInterface dialog, int i){  
