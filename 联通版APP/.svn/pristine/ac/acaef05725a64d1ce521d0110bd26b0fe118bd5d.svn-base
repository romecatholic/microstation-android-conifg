...
public class AlarmNoConfirmFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		pd.show();String IP = "http://";
		
		String IPPORT = dbMgr.queryInterface();
		String url = IP+ IPPORT+"/DlyAppSever/AlarmServlet";
		new LoadDataAsyncTask(AlarmNoConfirmFragment.this).execute(url + pageNo);
		...
		refresh_lv
				.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
					...
					public void onPullUpToRefresh(
							PullToRefreshBase<ListView> refreshView) {
						Log.e("@@@@@@@@", "" + pageNo);
						new LoadDataAsyncTask(AlarmNoConfirmFragment.this)
								.execute();
		...
		refresh_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v, int len,
				...
				AlarmInfo item = (AlarmInfo) adapter.getItem(len);
	...
	private class LoadDataAsyncTask extends AsyncTask<String, Void, String> {
		...
		private AlarmNoConfirmFragment alarmFragment;

		public LoadDataAsyncTask(AlarmNoConfirmFragment alarmFragment) {
		...
		protected String doInBackground(String... arg0) {
			...
			list.add(new BasicNameValuePair("operateState", "0"));// 确认告警状态位
			...
			list.add(new BasicNameValuePair("alarmName", searchAlarmName));//告警名称
