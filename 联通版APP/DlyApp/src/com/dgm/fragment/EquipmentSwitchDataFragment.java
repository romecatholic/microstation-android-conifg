...
//	private static final String IP = "http://192.168.10.218:8080/DlyAppSever/EquipmentDataServlet";
	...
	private static class DataAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (status.compareTo(convertView.getResources().getString(R.string.unknown_device)) == 0) {//未知
			...
			} else if (status.compareTo(convertView.getResources().getString(R.string.normal)) == 0) {//正常
